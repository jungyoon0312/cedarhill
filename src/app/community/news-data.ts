...
export const newsPosts: NewsPost[] = [
  {
    ...
    date: "2026-01-27",
    content: "26년 1월 27일(토), 인테리어 공사가 마무리 중인 씨더힐 현장에서 2차 입학 설명회가 진행되었습니다.\n\n굳은 날씨에도 많은 가족들이 참석해 주셨습니다.\n\n약 한 시간의 기관 소개와 커리큘럼 안내 이후, 마무리 단계에 있는 교습 시설을 둘러보는 간단한 투어가 가능한 날이었습니다.\n\n씨더힐 1회 입학생들은 새로운 시설을 처음으로 이용하게 됩니다. 기대해 주세요!",
    images: [
  ...
  },
  {
    ...
    date: "2025-12-27",
    content: "2025년 12월 27일 (토) 라마다 송도에서 제 1회 씨더힐 글로벌 어학원 입학 설명회가 진행되었습니다.\n\n첫 설명회에도 불구하고 많은 학부형과 아동들이 참석해 주셨습니다.\n\n개강을 앞둔 기관 소개와 전반적인 커리큘럼, 등록 절차, 교육 일정 및 방과후 활동에 대한 설명이 있었습니다.\n\n방문해주신 모든 분들께 감사드립니다.",
    images: [
